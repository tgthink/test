  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="/test/inspiration/translate/index.php/Home/Index/newspaper_list/">翻译新闻列表</a></li>
    ...
    <section class="content">
      ...
      <!-- START CUSTOM TABS -->
      <h2 class="page-header"><?php echo ($currentNewspaper->title); ?></h2>

      <div class="box">
        <!-- Custom Tabs -->
        <div class="nav-tabs-custom">
          <ul class="nav nav-tabs">
            <li class="active"><a href="#tab_1" data-toggle="tab">英中对照</a></li>
            <li><a href="#tab_2" data-toggle="tab">英文在前</a></li>
            <li><a href="#tab_3" data-toggle="tab">只看英文</a></li>
            <li><a href="#tab_4" data-toggle="tab">只看中文</a></li>
            <!--li class="dropdown">
